...
pub(crate) struct AppState {
    ...
    feature_flags: security::FeatureFlags,
    rate_limiter: security::RateLimiter,
    idempotency_store: security::IdempotencyStore,
}
...
async fn main() {
    ...
    let feature_flags = security::FeatureFlags::from_env();
    ...
    let state = AppState {
        ...
        idempotency_store: security::IdempotencyStore::new(),
    };
